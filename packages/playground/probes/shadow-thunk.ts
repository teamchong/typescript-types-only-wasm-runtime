...
type $ReadMem<S extends $State, A extends WasmValue> =
  $AlignAddr<A> extends infer AA extends WasmValue
    ? AA extends keyof S['memory']
      ? S['memory'][AA] extends () => infer V extends WasmValue ? V : '00000000000000000000000000000000'
...
type $clear<$S extends $State, $p0 extends WasmValue> =
  $Store8<$S, Wasm.I32Add<$p0, '00000000000000000010000000000000'>, '00000000000000000000000000100000'> extends infer $S1 extends $State
    ? Wasm.I32Add<$p0, '00000000000000000000000000000001'> extends infer $p1 extends WasmValue
      ? Wasm.I32Neq<$p1, '00000000000000000000000001000100'> extends '00000000000000000000000000000000'
        ? [$S1, $p1]
        : $clear<$S1, $p1>
      : never
    : never
...
type $Byte<S extends $State, A extends WasmValue> =
  Wasm.I32And<Wasm.I32ShrU<$ReadMem<S, A>, Wasm.I32Shl<$ByteOffset<A>, '00000000000000000000000000000011'>>, '00000000000000000000000011111111'>
type $Out = $GetState<$Run> extends infer S extends $State
  ? `${Convert.WasmValue.ToTSNumber<$GetValue<$Run> & string, 'i32'>}|${Convert.WasmValue.ToTSNumber<$Byte<S, '00000000000000000010000000110100'>, 'i32'>}|${Convert.WasmValue.ToTSNumber<$Byte<S, '00000000000000000010000000111100'>, 'i32'>}|${Convert.WasmValue.ToTSNumber<$Byte<S, '00000000000000000010000001000011'>, 'i32'>}`
  : 'no state'
