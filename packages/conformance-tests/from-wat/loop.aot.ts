...
type $loop_0_0<$S extends $State, $p0 extends WasmValue, $l0_1 extends WasmValue, $l0_2 extends WasmValue> =
  Wasm.I32LtS<Wasm.I32Add<$l0_1, '00000000000000000000000000000001'>, '00000000000000000000000000000011'> extends '00000000000000000000000000000000' ? [$S, Wasm.I32Mul<$l0_2, '00000000000000000000000000000010'>] : $loop_0_0<$S, $p0, Wasm.I32Add<$l0_1, '00000000000000000000000000000001'>, Wasm.I32Mul<$l0_2, '00000000000000000000000000000010'>>

type $func_0_impl<$S extends $State, $p0 extends WasmValue> =
  [$S, $GetValue<$loop_0_0<$S, $p0, '00000000000000000000000000000000', $p0>>]
