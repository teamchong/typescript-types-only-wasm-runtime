...
export type $b0_1<$F extends string, $K extends unknown[], $M extends $Node, $l1 extends WasmValue> =
  $F extends `1${infer $F1}`
  ? ['r', $F1, $M, $l1]
  : ['s', [['0_1', '0', $l1], ...$K], $Flush<$M>]


export type $b0_2<$F extends string, $K extends unknown[], $M extends $Node> =
  $F extends `1${infer $F1}`
  ? $b0_1<$F1, $K, $M, '00000000000000000000000001100011'>
  : ['s', [['0_2', '0'], ...$K], $Flush<$M>]


export type $b0_3<$F extends string, $K extends unknown[], $M extends $Node> =
  $F extends `1${infer $F1}`
  ? $b0_1<$F1, $K, $M, '00000000000000000000000000101010'>
  : ['s', [['0_3', '0'], ...$K], $Flush<$M>]


export type $b0_4<$F extends string, $K extends unknown[], $M extends $Node, $l0 extends WasmValue> =
  $F extends `1${infer $F1}`
  ? $Eq<$l0, '00000000000000000000000000000001'> extends infer $t0 extends WasmValue
    ...
    : $b0_2<$F1, $K, $M>
    : never
  : ['s', [['0_4', '0', $l0], ...$K], $Flush<$M>]


export type $b0_5<$F extends string, $K extends unknown[], $M extends $Node> =
  $F extends `1${infer $F1}`
  ? $b0_1<$F1, $K, $M, '00000000000000000000000000000111'>
  : ['s', [['0_5', '0'], ...$K], $Flush<$M>]
