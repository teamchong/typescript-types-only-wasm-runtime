...
export type $b1_0<$F extends string, $K extends unknown[], $M extends $Node, $l2 extends WasmValue> =
  $F extends `1${infer $F1}`
  ? $call0<$F1, [['1_1', '1'], ...$K], $M, $l2> extends infer $c0
    ? $c0 extends ['r', infer $Fr1 extends string, infer $m2 extends $Node, infer $t3 extends WasmValue]
      ? $b1_1<$Fr1, $K, $m2, $t3>
      : $c0
    : never
  : ['s', [['1_0', '0', $l2], ...$K], $Flush<$M>]
