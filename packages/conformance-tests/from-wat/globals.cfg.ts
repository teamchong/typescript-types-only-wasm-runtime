...
export type $b2_0<$F extends string, $M extends $Node, $g0 extends WasmValue> =
  $F extends `1${infer $F1}`
  ? $call0<$M, $g0> extends ['r', infer $m0 extends $Node, infer $g_1 extends WasmValue]
    ? $call1<$m0, $g_1> extends ['r', infer $m2 extends $Node, infer $g_3 extends WasmValue, infer $t4 extends WasmValue]
    ? ['r', $Flush<$m2>, $t4]
    : never
    : never
  : ['s', '2_0', $Flush<$M>, $g0]
...
export type $u1_0<$M extends $Node, $g0 extends WasmValue> =
  ['r', $M, $g0, $g0]


export type $call1<$M extends $Node, $g0 extends WasmValue> =
  $u1_0<$M, $g0>

export type $u0_0<$M extends $Node, $g0 extends WasmValue> =
  ['r', $M, '00000000000000000000000000101010']


export type $call0<$M extends $Node, $g0 extends WasmValue> =
  $u0_0<$M, $g0>

export type $entry<$F extends string, $M extends $Node> =
  $b2_0<$F, $Buf<$M>, '00000000000000000000000000000000'>
