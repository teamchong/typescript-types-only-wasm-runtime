...
export type $b1_0<$F extends string, $M extends $Node, $l0 extends WasmValue, $l1 extends WasmValue, $l2 extends WasmValue> =
  $F extends `1${infer $F1}`
  ? $call0<$M, $l0, $l1, $l2> extends ['r', infer $m0 extends $Node, infer $t1 extends WasmValue]
    ? ['r', $Flush<$m0>, $t1]
    : never
  : ['s', '1_0', $Flush<$M>, $l0, $l1, $l2]
...
export type $call0<$M extends $Node, $p0 extends WasmValue, $p1 extends WasmValue, $p2 extends WasmValue> =
  $u0_0<$M, $p0, $p1, $p2>

export type $entry<$F extends string, $M extends $Node, $p0 extends WasmValue, $p1 extends WasmValue, $p2 extends WasmValue> =
  $b1_0<$F, $Buf<$M>, $p0, $p1, $p2>
