...
export type $b0_1<$F extends string, $K extends unknown[], $M extends $Node, $g0 extends WasmValue, $k0 extends WasmValue, $k1 extends WasmValue, $k2 extends WasmValue> =
