...
// 7 levels stays clear of that, and it also costs 7 instantiations per
// read or write instead of 21.
...
/// the addressing bits of an address: drop the two byte-offset bits, keep 21
export type $Slice<A extends string> =
  A extends `${infer _h0}${infer _h1}${infer _h2}${infer _h3}${infer _h4}${infer _h5}${infer _h6}${infer _h7}${infer _h8}${infer b0}${infer b1}${infer b2}${infer b3}${infer b4}${infer b5}${infer b6}${infer b7}${infer b8}${infer b9}${infer b10}${infer b11}${infer b12}${infer b13}${infer b14}${infer b15}${infer b16}${infer b17}${infer b18}${infer b19}${infer b20}${infer _l0}${infer _l1}`
...
export type $Split<A extends string> =
  A extends `${infer _h0}${infer _h1}${infer _h2}${infer _h3}${infer _h4}${infer _h5}${infer _h6}${infer _h7}${infer _h8}${infer b0}${infer b1}${infer b2}${infer b3}${infer b4}${infer b5}${infer b6}${infer b7}${infer b8}${infer b9}${infer b10}${infer b11}${infer b12}${infer b13}${infer b14}${infer b15}${infer b16}${infer b17}${infer b18}${infer b19}${infer b20}${infer _l0}${infer _l1}`
    ? [`${b0}${b1}${b2}${b3}${b4}${b5}${b6}${b7}${b8}${b9}${b10}${b11}${b12}${b13}${b14}${b15}${b16}${b17}`, [`${b0}${b1}${b2}`, `${b3}${b4}${b5}`, `${b6}${b7}${b8}`, `${b9}${b10}${b11}`, `${b12}${b13}${b14}`, `${b15}${b16}${b17}`], `${b18}${b19}${b20}`]
    : never
...
export type $Flush<M> = M extends [infer T, infer K, infer B extends unknown[], infer S extends unknown[]]
  ...
  : M
export type $Buf<T> = [T, 'eeeeeeeeeeeeeeeeee', [], $Empty]
...
/// 7 rebuild levels each, and a scattered store costs what it did before.
...
export type $Write<M extends $Node, A extends WasmValue, V extends WasmValue> =
  $Split<A> extends [infer K extends string, infer B extends unknown[], infer D extends string]
    ? M extends [infer T, infer MK, infer MB extends unknown[], infer S extends unknown[]]
      ? K extends MK
        ? [T, MK, MB, $Set<S, D, [V]>]
        : [(MK extends 'eeeeeeeeeeeeeeeeee' ? T : $MergeAt<T, MB, S>), K, B, $Set<$Empty, D, [V]>]
      : never
    : never
