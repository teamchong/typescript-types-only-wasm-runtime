...
export type $b0_1<$F extends string, $K extends unknown[], $M extends $Node, $k0 extends WasmValue, $k1 extends WasmValue> =
  $F extends `1${infer $F1}`
  ? Wasm.I32Add<$k0, $k1> extends infer $t0 extends WasmValue
    ? ['r', $F1, $M, $t0]
    : never
  : ['s', [['0_1', '0', $k0, $k1], ...$K], $Flush<$M>]


export type $b0_2<$F extends string, $K extends unknown[], $M extends $Node, $k0 extends WasmValue> =
  $F extends `1${infer $F1}`
  ? $b0_1<$F1, $K, $M, $k0, '00000000000000000000000000000001'>
  : ['s', [['0_2', '0', $k0], ...$K], $Flush<$M>]


export type $b0_3<$F extends string, $K extends unknown[], $M extends $Node, $k0 extends WasmValue> =
  $F extends `1${infer $F1}`
  ? $b0_1<$F1, $K, $M, $k0, '11111111111111111111111111111111'>
  : ['s', [['0_3', '0', $k0], ...$K], $Flush<$M>]
