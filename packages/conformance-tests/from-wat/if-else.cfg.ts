...
export type $u0_2<$M extends $Node, $k0 extends WasmValue> =
  $u0_1<$M, $k0, '00000000000000000000000000000001'>


export type $u0_3<$M extends $Node, $k0 extends WasmValue> =
  $u0_1<$M, $k0, '11111111111111111111111111111111'>
