...
export type $b1_0<$F extends string, $M extends $Node, $l0 extends WasmValue> =
  $F extends `1${infer $F1}`
  ? $call0<$M, $l0> extends ['r', infer $m0 extends $Node, infer $t1 extends WasmValue]
    ? ['r', $Flush<$m0>, $t1]
    : never
  : ['s', '1_0', $Flush<$M>, $l0]


export type $u0_0<$M extends $Node, $l0 extends WasmValue> =
...
export type $call0<$M extends $Node, $p0 extends WasmValue> =
  $u0_0<$M, $p0>
