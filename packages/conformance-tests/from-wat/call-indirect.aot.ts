...
// call_indirect dispatch for type 0 (1 reachable target)
type $indirect_0<$S extends $State, $callee extends WasmValue, $a0 extends WasmValue, $a1 extends WasmValue> =
  $callee extends '00000000000000000000000000000000' ? $func_0_impl<$S, $a0, $a1> :
  never
...
type $func_1_impl<$S extends $State, $p0 extends WasmValue, $p1 extends WasmValue> =
  [$GetState<$indirect_0<$S, '00000000000000000000000000000000', $p0, $p1>>, $GetValue<$indirect_0<$S, '00000000000000000000000000000000', $p0, $p1>>]

type $entry_impl<$S extends $State, $p0 extends WasmValue, $p1 extends WasmValue> =
  [$GetState<$func_1_impl<$S, $p0, $p1>>, $GetValue<$func_1_impl<$S, $p0, $p1>>]
