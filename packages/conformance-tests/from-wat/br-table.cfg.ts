...
export type $b0_0<$F extends string, $K extends unknown[], $M extends $Node, $l0 extends WasmValue> =
  ...
  ? $l0 extends '00000000000000000000000000000000' ? $b0_3<$F1, $K, $M>
    : $l0 extends '00000000000000000000000000000001' ? $b0_2<$F1, $K, $M>
    : $l0 extends '00000000000000000000000000000010' ? $b0_1<$F1, $K, $M>
    : $b0_4<$F1, $K, $M>
...
export type $b0_1<$F extends string, $K extends unknown[], $M extends $Node> =
  $F extends `1${infer $F1}`
  ? ['r', $F1, $M, '00000000000000000000000001100111']
  : ['s', [['0_1', '0'], ...$K], $Flush<$M>]


export type $b0_2<$F extends string, $K extends unknown[], $M extends $Node> =
  $F extends `1${infer $F1}`
  ? ['r', $F1, $M, '00000000000000000000000001100110']
  : ['s', [['0_2', '0'], ...$K], $Flush<$M>]


export type $b0_3<$F extends string, $K extends unknown[], $M extends $Node> =
  $F extends `1${infer $F1}`
  ? ['r', $F1, $M, '00000000000000000000000001100101']
  : ['s', [['0_3', '0'], ...$K], $Flush<$M>]


export type $b0_4<$F extends string, $K extends unknown[], $M extends $Node> =
  $F extends `1${infer $F1}`
  ? ['r', $F1, $M, '00000000000000000000000001100100']
  : ['s', [['0_4', '0'], ...$K], $Flush<$M>]
