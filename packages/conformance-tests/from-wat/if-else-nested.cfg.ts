...
export type $u0_2<$M extends $Node, $l0 extends WasmValue> =
  Wasm.I32Add<'00000000000000000000000001100101', $l0> extends infer $t0 extends WasmValue
    ? $u0_1<$M, $t0>
    : never
...
export type $u0_6<$M extends $Node, $l0 extends WasmValue, $l1 extends WasmValue> =
  Wasm.I32GeS<$l1, '00000000000000000000000000000011'> extends infer $t0 extends WasmValue
    ? $t0 extends '00000000000000000000000000000000'
    ? $u0_9<$M, $l0>
    : $u0_8<$M, $l0, $l1>
    : never
...
export type $u0_8<$M extends $Node, $l0 extends WasmValue, $l1 extends WasmValue> =
  Wasm.I32GtS<$l1, '00000000000000000000000000000101'> extends infer $t0 extends WasmValue
    ? $t0 extends '00000000000000000000000000000000'
    ? $u0_12<$M, $l0>
    : $u0_11<$M, $l0>
    : never
...
export type $u0_9<$M extends $Node, $l0 extends WasmValue> =
  Wasm.I32Add<'00000000000000000000000001101001', $l0> extends infer $t0 extends WasmValue
    ? $u0_7<$M, $t0>
    : never
...
export type $u0_12<$M extends $Node, $l0 extends WasmValue> =
  Wasm.I32Add<'00000000000000000000000001101000', $l0> extends infer $t0 extends WasmValue
    ? $u0_10<$M, $t0>
    : never
