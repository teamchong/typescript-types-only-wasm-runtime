...
type $v2_0<$S extends $State, $p0 extends WasmValue, $p1 extends WasmValue> =
  Wasm.I32Add<$GetValue<$indirect_0<$S, '00000000000000000000000000000001', $p0, $p1>>, $GetValue<$indirect_0<$GetState<$indirect_0<$S, '00000000000000000000000000000001', $p0, $p1>>, '00000000000000000000000000000010', $p0, $p1>>>

// call_indirect dispatch for type 0 (2 reachable targets)
type $indirect_0<$S extends $State, $callee extends WasmValue, $a0 extends WasmValue, $a1 extends WasmValue> =
  $callee extends '00000000000000000000000000000001' ? $func_0_impl<$S, $a0, $a1> :
  $callee extends '00000000000000000000000000000010' ? $func_1_impl<$S, $a0, $a1> :
  never

type $func_0_impl<$S extends $State, $p0 extends WasmValue, $p1 extends WasmValue> =
  [$S, Wasm.I32Add<$p0, $p1>]

type $func_1_impl<$S extends $State, $p0 extends WasmValue, $p1 extends WasmValue> =
  [$S, Wasm.I32Mul<$p0, $p1>]

type $entry_impl<$S extends $State, $p0 extends WasmValue, $p1 extends WasmValue> =
  [$GetState<$indirect_0<$GetState<$indirect_0<$S, '00000000000000000000000000000001', $p0, $p1>>, '00000000000000000000000000000010', $p0, $p1>>, $v2_0<$S, $p0, $p1>]
