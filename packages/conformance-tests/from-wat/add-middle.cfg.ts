...
export type $b1_0<$F extends string, $M extends $Node, $g0 extends WasmValue, $g1 extends WasmValue, $g2 extends WasmValue, $l0 extends WasmValue, $l1 extends WasmValue> =
  ...
  ? Wasm.I32Sub<$g0, '00000000000000000000000000010000'> extends infer $t0 extends WasmValue
    ? Wasm.I32Add<$t0, '00000000000000000000000000001100'> extends infer $t1 extends WasmValue
    ? $Store32<$M, $t1, $l0> extends infer $m2 extends $Node
    ? Wasm.I32Add<$t0, '00000000000000000000000000001000'> extends infer $t3 extends WasmValue
    ? $Store32<$m2, $t3, $l1> extends infer $m4 extends $Node
    ? $Load32<$m4, $t1> extends infer $t5 extends WasmValue
    ? $b1_1<$F1, $m4, $g0, $g1, $g2, $t0, $t5>
    : never
    : never
    : never
    : never
...
export type $b1_1<$F extends string, $M extends $Node, $g0 extends WasmValue, $g1 extends WasmValue, $g2 extends WasmValue, $l4 extends WasmValue, $k0 extends WasmValue> =
  $F extends `1${infer $F1}`
  ? Wasm.I32Add<$l4, '00000000000000000000000000001000'> extends infer $t0 extends WasmValue
    ? $Load32<$M, $t0> extends infer $t1 extends WasmValue
    ? Wasm.I32Add<$k0, $t1> extends infer $t2 extends WasmValue
    ? ['r', $Flush<$M>, $t2]
    : never
    : never
    : never
  : ['s', '1_1', $Flush<$M>, $g0, $g1, $g2, $l4, $k0]


export type $b2_0<$F extends string, $M extends $Node, $g0 extends WasmValue, $g1 extends WasmValue, $g2 extends WasmValue> =
  $F extends `1${infer $F1}`
  ? $AndFFFFFFF0<'00000000000000000000010000010011'> extends infer $t0 extends WasmValue
    ? ['r', $Flush<$M>]
    : never
