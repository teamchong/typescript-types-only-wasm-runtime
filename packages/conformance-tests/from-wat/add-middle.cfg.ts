...
// 8 levels stays clear of that, and it also costs 8 instantiations per
...
export type $Split<A extends string> =
  A extends `${infer _h0}${infer _h1}${infer _h2}${infer _h3}${infer _h4}${infer _h5}${infer b0}${infer b1}${infer b2}${infer b3}${infer b4}${infer b5}${infer b6}${infer b7}${infer b8}${infer b9}${infer b10}${infer b11}${infer b12}${infer b13}${infer b14}${infer b15}${infer b16}${infer b17}${infer b18}${infer b19}${infer b20}${infer b21}${infer b22}${infer b23}${infer _l0}${infer _l1}`
    ? [`${b0}${b1}${b2}${b3}${b4}${b5}${b6}${b7}${b8}${b9}${b10}${b11}${b12}${b13}${b14}${b15}${b16}${b17}${b18}${b19}${b20}`, [`${b0}${b1}${b2}`, `${b3}${b4}${b5}`, `${b6}${b7}${b8}`, `${b9}${b10}${b11}`, `${b12}${b13}${b14}`, `${b15}${b16}${b17}`, `${b18}${b19}${b20}`], `${b21}${b22}${b23}`]
    : never
...
export type $Flush<M> = M extends [infer T, infer K, infer B extends unknown[], infer S extends unknown[]]
  ? K extends 'eeeeeeeeeeeeeeeeeeeee' ? T : $MergeAt<T, B, S>
  : M
export type $Buf<T> = [T, 'eeeeeeeeeeeeeeeeeeeee', [], $Empty]
...
/// 8 rebuild levels each, and a scattered store costs what it did before.
...
export type $Write<M extends $Node, A extends WasmValue, V extends WasmValue> =
  $Split<A> extends [infer K extends string, infer B extends unknown[], infer D extends string]
    ? M extends [infer T, infer MK, infer MB extends unknown[], infer S extends unknown[]]
      ? K extends MK
        ? [T, MK, MB, $Set<S, D, [V]>]
        : [(MK extends 'eeeeeeeeeeeeeeeeeeeee' ? T : $MergeAt<T, MB, S>), K, B, $Set<$Empty, D, [V]>]
      : never
    : never
...
export type $b1_0<$F extends string, $K extends unknown[], $M extends $Node, $g0 extends WasmValue, $g1 extends WasmValue, $g2 extends WasmValue, $g3 extends WasmValue, $l0 extends WasmValue, $l1 extends WasmValue> =
  ...
  ? $Dec2<$Dec4<$g0>> extends infer $t0 extends WasmValue
    ...
    : never
    : never
  : ['s', [['1_0', '0', $l0, $l1], ...$K], $Flush<$M>, $g0, $g1, $g2, $g3]


export type $b1_1<$F extends string, $K extends unknown[], $M extends $Node, $g0 extends WasmValue, $g1 extends WasmValue, $g2 extends WasmValue, $g3 extends WasmValue, $k0 extends WasmValue> =
  $F extends `1${infer $F1}`
  ? ['r', $F1, $M, $g0, $g1, $g2, $g3, $k0]
  : ['s', [['1_1', '0', $k0], ...$K], $Flush<$M>, $g0, $g1, $g2, $g3]
