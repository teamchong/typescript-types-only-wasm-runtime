...
export type $call1<$F extends string, $K extends unknown[], $M extends $Node> =
  $b1_0<$F, $K, $M>

export type $b2_0<$F extends string, $K extends unknown[], $M extends $Node> =
  $F extends `1${infer $F1}`
  ? $call1<$F1, [['2_1', '1'], ...$K], $M> extends infer $c0
    ? $c0 extends ['r', infer $Fr1 extends string, infer $m2 extends $Node, infer $t3 extends WasmValue]
      ? $b2_1<$Fr1, $K, $m2, $t3>
      : $c0
    : never
