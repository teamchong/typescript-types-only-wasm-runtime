...
export type $b1_0<$F extends string, $K extends unknown[], $M extends $Node, $g0 extends WasmValue, $g1 extends WasmValue, $g2 extends WasmValue, $g3 extends WasmValue, $g4 extends WasmValue, $g5 extends WasmValue, $g6 extends WasmValue, $g7 extends WasmValue, $g8 extends WasmValue, $l0 extends WasmValue> =
  $F extends `1${infer $F1}`
  ? $Dec0<$l0> extends infer $t0 extends WasmValue
    ...
    ? ['r', $F1, $M, $g0, $g1, $g2, $g3, $g4, $g5, $g6, $g7, $g8, $t2]
    : never
    : never
    : never
  : ['s', [['1_0', $l0], ...$K], $Flush<$M>, $g0, $g1, $g2, $g3, $g4, $g5, $g6, $g7, $g8]


export type $b2_0<$F extends string, $K extends unknown[], $M extends $Node, $g0 extends WasmValue, $g1 extends WasmValue, $g2 extends WasmValue, $g3 extends WasmValue, $g4 extends WasmValue, $g5 extends WasmValue, $g6 extends WasmValue, $g7 extends WasmValue, $g8 extends WasmValue, $l0 extends WasmValue> =
  ...
  ? $Dec0<$l0> extends infer $t0 extends WasmValue
    ...
    ? ['r', $F1, $m4, $g0, $g1, $g2, $g3, $g4, $g5, $g6, $g7, $g8, '00000000000000000000010000000000']
    : never
    : never
    : never
    : never
    : never
  : ['s', [['2_0', $l0], ...$K], $Flush<$M>, $g0, $g1, $g2, $g3, $g4, $g5, $g6, $g7, $g8]
