...
export type $b1_0<$F extends string, $M extends $Node, $g0 extends WasmValue, $g1 extends WasmValue, $g2 extends WasmValue, $g3 extends WasmValue, $g4 extends WasmValue, $g5 extends WasmValue, $g6 extends WasmValue, $g7 extends WasmValue, $g8 extends WasmValue, $l0 extends WasmValue, $l1 extends WasmValue> =
  $F extends `1${infer $F1}`
  ? Wasm.I32Add<$l0, $l1> extends infer $t0 extends WasmValue
    ? ['r', $Flush<$M>, $t0]
    : never
  : ['s', '1_0', $Flush<$M>, $g0, $g1, $g2, $g3, $g4, $g5, $g6, $g7, $g8, $l0, $l1]


export type $__wasm_call_ctors<$F extends string, $M extends $Node> =
  $b0_0<$F, $Buf<$M>, '00000000000000000000010000000000', '00000000000000000000010000000000', '00000000000000000000010000000000', '00000000000000010000010000000000', '00000000000000000000010000000000', '00000000000000010000010000000000', '00000000000000100000000000000000', '00000000000000000000000000000000', '00000000000000000000000000000001'>

export type $entry<$F extends string, $M extends $Node, $p0 extends WasmValue, $p1 extends WasmValue> =
  $b1_0<$F, $Buf<$M>, '00000000000000000000010000000000', '00000000000000000000010000000000', '00000000000000000000010000000000', '00000000000000010000010000000000', '00000000000000000000010000000000', '00000000000000010000010000000000', '00000000000000100000000000000000', '00000000000000000000000000000000', '00000000000000000000000000000001', $p0, $p1>
